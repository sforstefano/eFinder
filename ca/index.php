      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="templateux-navbar-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item"><a class="nav-link" href="#section-home">Inici</a></li>
            <li class="nav-item"><a class="nav-link" href="#section-destacado">Destacat</a></li>
            <li class="nav-item"><a class="nav-link" href="#section-events">Tots</a></li>
            <li class="nav-item"><a class="nav-link" href="#section-testimoni">Sobre nosaltres</a></li>
            <li class="nav-item cta-btn ml-xl-2 ml-lg-2 ml-md-0 ml-sm-0 ml-0"><a class="nav-link" href="pages/formusuari.php"><span class="pb_rounded-4 px-4 rounded">Registra't</span></a></li>
            <li class="nav-item"><a href="index.php"><img src="../images/ca.png" alt="ca" class="nav-link fotoidioma"></a></li>
            <li class="nav-item"><a href="../en/index.php"><img src="../images/en.png" alt="en" class="nav-link fotoidioma"></a></li>
          </ul>
        </div>
      </div>
    </nav>
              ...
              <form action="../php/vista.php" method="post">
                <div class="row">
                  <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                    <label for="checkin_date" class="font-weight-bold text-black">Localizació</label>
                  ...
                  <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                    <label for="checkout_date" class="font-weight-bold text-black">Tipus</label>
                    <div class="field-icon-wrap">
                      <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                  ...
                  <div class="col-md-6 mb-3 mb-md-0 col-lg-3">
                    <div class="row">
                      <div class="col-md-6 mb-3 mb-md-0">
                        <label for="children" class="font-weight-bold text-black">Preu</label>
                        <div class="field-icon-wrap">
                          <div class="icon"><span class="ion-ios-arrow-down"></span></div>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
              <h2 class="heading mb-4">Benvingut!</h2>
              <h2 class="text-black font-weight-bold">Vols publicar el teu esdeveniment? <br> Registra't ara!</h2>
              <a href="pages/formpromotor.php" class="btn btn-outline-secondary py-3 text-black px-5">Uneix-te</a>
            </div>
          </div>
        </div>
      </section>
    <!-- END .block-2 -->
      <section class="section" id="section-rooms">
        <div class="container">
          <div class="row justify-content-center text-center mb-5">
            <div class="col-md-7">
              <h2 class="heading" data-aos="fade-up">Últims esdeveniments</h2>
            </div>
          </div>
          <div class="row">
      ...
      <section class="section bg-image overlay" style="background-image: url('../images/hero_3.jpg');" id="section-destacado">
        <div class="container">
          <div class="row justify-content-center text-center mb-5">
            <div class="col-md-7">
              <h2 class="heading text-white" data-aos="fade">Esdeveniments més destacats</h2>
              <p class="text-white" data-aos="fade" data-aos-delay="100">Llista dels esdeveniments més destacats del mes. Concerts, projeccions, exhibicions...</p>
            </div>
          </div>
          <div class="food-menu-tabs" data-aos="fade">
            <ul class="nav nav-tabs mb-5" id="myTab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link letter-spacing-2" id="desserts-tab" data-toggle="tab" href="#desserts" role="tab" aria-controls="desserts" aria-selected="false">Projeccions</a>
              </li>
              <li class="nav-item">
                <a class="nav-link letter-spacing-2" id="drinks-tab" data-toggle="tab" href="#drinks" role="tab" aria-controls="drinks" aria-selected="false">Exhibicions</a>
              </li>
            </ul>
      ...
      <section class="section blog-post-entry bg-light" id="section-events">
        <div class="container">
          <div class="row justify-content-center text-center mb-5">
            <div class="col-md-7">
              <h2 class="heading" data-aos="fade-up">Tots els esdeveniments</h2>
            </div>
          </div>
      ...
      <section class="section testimonial-section" id="section-testimoni">
        <div class="container">
          <div class="row justify-content-center text-center mb-5">
            <div class="col-md-7">
              <h2 class="heading" data-aos="fade-up">Sobre nosaltres</h2>
            </div>
          </div>
          <div class="row">
            <div class="js-carousel-2 owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="testimonial text-center slider-item">
                ...
                <blockquote>
                  <p>&ldquo;LightCode m'ha permès no només mostrar-me com artista, sinó descobrir noves experiències que, de no ser per ells, probablement no hauria viscut mai.&rdquo;</p>
                </blockquote>
                <p><em>&mdash; Aleix Bernadó, artista bohemi</em></p>
              </div>
              ...
              <div class="testimonial text-center slider-item">
                ...
                <blockquote>
                  ...
                  <p>&ldquo;Lightcode ha fet molt més visible el molt que ofereixen tots els petits pobles.&rdquo;</p>
                </blockquote>
                <p><em>&mdash; Juan Gomez, regidor de cultura</em></p>
              </div>
              ...
              <div class="testimonial text-center slider-item">
                ...
                <blockquote>
                  ...
                  <p>&ldquo;Gràcies a LightCode, podem arribar a més públic que realment gaudirà del nostre treball.&rdquo;</p>
                </blockquote>
          ...
          <div class="row">
            <div class="col-md-4 mb-5">
              <ul class="list-unstyled link">
                <li><a href="#section-home">Inici</a></li>
                <li><a href="#section-destacado">Destacat</a></li>
                <li><a href="#section-events">Tots</a></li>
                <li><a href="#section-testimoni">Sobre nosaltres</a></li>
              </ul>
            </div>
            <div class="col-md-4 mb-5">
              <ul class="list-unstyled link">
                ...
                <li><a href="../php/fitxerdetext.php">Generar esdeveniments amb TXT</a></li>
                <li><a href="pages/crearevent.php">Crear un esdeveniment amb XML</a></li>
              </ul>
            </div>
