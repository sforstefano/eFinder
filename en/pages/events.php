...
<html>
  ...
  ?>
  <body data-spy="scroll" data-target="#section-event"  data-offset="200">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="templateux-navbar-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="../index.php#section-destacado">Relevant</a></li>
          <li class="nav-item"><a class="nav-link" href="../index.php#section-events">All events</a></li>
          <li class="nav-item"><a class="nav-link" href="../index.php#section-testimoni">About us</a></li>
          ...
          <li class="nav-item"><?php echo("<a href='../../ca/pages/$link'>"); ?><img src="../../images/ca.png" alt="ca" class="nav-link fotoidioma"></a></li>
          <li class="nav-item"><a href=""><img src="../../images/en.png" alt="en" class="nav-link fotoidioma"></a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <section class="site-hero overlay" style="background-image: url(../../images/hero_5.jpg)" data-stellar-background-ratio="0.5" id="section-home">
    ...
    <section class="section testimonial-section" id="section-event" >
      <div class="container">
        <?php
        ...
        <div class="row">
          <div class="col-md-4 mb-5">
            <ul class="list-unstyled link">
              ...
              <li><a href="../index.php#section-destacado">Relevant</a></li>
              <li><a href="../index.php#section-events">All events</a></li>
              <li><a href="../index.php#section-testimoni">About us</a></li>
            </ul>
          </div>
          <div class="col-md-4 mb-5">
            <ul class="list-unstyled link">
