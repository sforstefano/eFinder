                ...
                <form method="post" action="../../php/vista.php" class="bg-formpanel p-md-5 p-4 mb-5 border">
                    <div class="row formularisnegre">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="nom_usuari" value= "<?php echo($nom_usuari)?>" id="user" class="form-control ">
                            </div>  
                            <div class="col-md-6 form-group">
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-6 form-group">
                            <label for="pasw">Repeat password</label>
                            <input type="password" name="paswd2" id="pasw" class="form-control ">
                            </div>
                            <div class="col-md-6 form-group">
                            <label for="cif">Cif</label>
                            <input type="text" name="cif_promotor" id="cif" class="form-control ">
                            </div>
                            <div class="col-md-6 form-group">
                            <label for="nom_local">Local name</label>
                            <input type="text" name="nom_local" id="nom_local" class="form-control ">
                            </div>
                            <div class="col-md-12 form-group">
                            <label for="adreca">Direction</label>
                            <input type="text" name="adreca" id="adreca" class="form-control ">
                            </div>
                            <div class="col-md-12 form-group">
